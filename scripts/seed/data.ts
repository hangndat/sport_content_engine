...
export const RULES: RuleRow[] = [
  ...
  { topicId: "vleague", ruleType: "competition_regex", ruleValue: { pattern: "v-?league|v\\s*league|vleague|v\\.league|hạng nhất|hạng nhì|cúp quốc gia" }, priority: 100 },
  ...
  { topicId: "c1", ruleType: "competition_regex", ruleValue: { pattern: "champions\\s*league|uefa\\s*cl|cúp c1|c1(?!\\d)" }, priority: 100 },
  ...
  { topicId: "vleague", ruleType: "teams_contains", ruleValue: { values: ["hà nội", "ha noi", "hanoi fc", "thể công", "the cong", "viettel", "nam định", "nam dinh", "thép xanh", "thanh hóa", "thanh hoa", "đông á", "bình dương", "binh duong", "becamex", "hoàng anh gia lai", "hagl", "hà tĩnh", "công an hà nội", "công an hn", "cahn", "hải phòng", "hai phong", "đà nẵng", "da nang", "shb", "quảng nam", "quang nam", "bình định", "binh dinh", "slna", "sông lam", "nghệ an", "hồ chí minh", "ho chi minh", "hcm fc"] }, priority: 200 },
  ...
  { topicId: "caf", ruleType: "title_regex", ruleValue: { pattern: "châu\\s*phi|vô địch châu phi|\\bcaf\\b|africa" }, priority: 300 },
  ...
  { topicId: "nha", ruleType: "title_regex", ruleValue: { pattern: "\\b(mainoo|saka|haaland|van persie|rashford|foden|rice|salah|kane|son heung-min|heung-min son|bernardo|martinelli)\\b" }, priority: 300 },
  ...
  { topicId: "dtvn", ruleType: "title_regex", ruleValue: { pattern: "tiến linh|quang hải|văn lâm|văn hậu|công phượng|đức huy|hoàng đức|đức chinh|bùi tiến dũng|hồng duy|phan văn đức|vũ văn thanh|đặng văn lâm|tiến dũng|văn đức|văn thanh|hùng dũng|ngọc hải|văn thái|văn tùng|tuấn hải|tấn trường|văn toàn|minh vương|minh trọng|văn khang|xuân mạnh|xuân son|xuân trường" }, priority: 300 },
  ...
  // title_regex khi competition/teams trống — giảm "Khác"
  { topicId: "vleague", ruleType: "title_regex", ruleValue: { pattern: "\\b(v-?league|v\\.league|v league|vleague)\\b" }, priority: 250 },
  { topicId: "vleague", ruleType: "title_regex", ruleValue: { pattern: "công an hà nội|cahn|viettel|nam định|thanh hóa|hagl|lpbank|hồng lĩnh hà tĩnh|slna|sông lam|bình dương|becamex|đà nẵng|hải phòng|quảng nam|bình định|hcm fc|cúp quốc gia" }, priority: 250 },
  { topicId: "c1", ruleType: "title_regex", ruleValue: { pattern: "cúp c1|champions league|uefa champions" }, priority: 250 },
  { topicId: "c2", ruleType: "title_regex", ruleValue: { pattern: "cúp c2|europa league|uefa europa" }, priority: 250 },
  { topicId: "c3", ruleType: "title_regex", ruleValue: { pattern: "cúp c3|conference league|europa conference" }, priority: 250 },
  { topicId: "nha", ruleType: "title_regex", ruleValue: { pattern: "ngoại hạng anh|premier league|bóng đá anh" }, priority: 250 },
  { topicId: "afc_champions", ruleType: "title_regex", ruleValue: { pattern: "afc champions|acl|champions league châu á" }, priority: 250 },
  { topicId: "laliga", ruleType: "title_regex", ruleValue: { pattern: "la liga|bóng đá tây ban nha" }, priority: 250 },
  { topicId: "seriea", ruleType: "title_regex", ruleValue: { pattern: "serie a|bóng đá ý|calcio" }, priority: 250 },
  { topicId: "bundesliga", ruleType: "title_regex", ruleValue: { pattern: "bundesliga|bóng đá đức" }, priority: 250 },
  { topicId: "ligue1", ruleType: "title_regex", ruleValue: { pattern: "ligue 1|bóng đá pháp" }, priority: 250 },
  { topicId: "aff", ruleType: "title_regex", ruleValue: { pattern: "\\b(aff|asean)\\b|suzuki\\s*cup|đông nam á" }, priority: 250 },
  { topicId: "asian_cup", ruleType: "title_regex", ruleValue: { pattern: "asian cup|châu á|asiacup" }, priority: 250 },
  { topicId: "worldcup", ruleType: "title_regex", ruleValue: { pattern: "world cup|worldcup" }, priority: 250 },
  { topicId: "euro", ruleType: "title_regex", ruleValue: { pattern: "euro\\s*20\\d{2}|uefa euro" }, priority: 250 },
];
